...
int main() 
{
	...
	//build_min_Heap(data, data.size()); //5, 8, 19, 16, 25, 33, 40, 50, 17 ,28
	build_min_Heap(data2, data2.size()); // 1, 3, 2, 5, 7, 8, 9, 10
	//build_min_Heap(data3, data3.size()); // 2, 3, 8, 5, 7, 9, 10, 6
	build_min_Heap(data4, data4.size()); // 2, 3, 8, 5, 7, 9, 10
}